...
namespace Server
{
    class MySqlHandler
    {
         ...
         public MySqlHandler(string ConnectionString, string DatenbankName)
         { 
         ...
         override protected Int32 select(Int32 ClientID)
         { 
         ...
         override protected Int32 insert(Int32 ClientID, Int32 Zeit)
         { 
         ...
         override protected Int32 insert(Int32 ClientID, Int32 Zeit, String ClientName)
         { 
         ...
         override protected Int32 update(Int32 ClientID, Int32 Zeit)
         { 
         ...
         override protected Int32 executeQuarry(string sCommand)
         { 
             try 
             { 
                 conn.Open(); 
         ...
         override protected Int32 executeReader(string sCommand)
         { 
             Int32 Data = -1; 
